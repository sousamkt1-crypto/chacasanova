...
export const categories: GiftCategory[] = [
  { name: "Cozinha", icon: CookingPot, items: [
    g("jogo-panelas","Jogo de panelas",2),g("panela-pressao","Panela de pressão",2),g("cuscuzeira-gelo","Kit cuscuzeira + forma de gelo"),g("frigideiras","Kit frigideiras"),g("forma-bolo-boleira","Kit forma de bolo + boleira"),g("travessas","Travessas"),g("pratos","Jogo de pratos",3),g("talheres","Jogo de talheres",2),g("sobremesas","Jogo de sobremesas"),g("xicaras","Kit de xícaras",2),g("tacas","Taças",2),g("copos-jarra","Kit jogo de copos + jarra para suco",2),g("potes-tampa","Potes com tampa",2),g("escorredor-detergente","Kit escorredor de louças + porta-detergente"),g("tabua-facas","Kit tábua de corte + jogo de facas",2),g("colheres-conchas","Kit colheres de silicone + conchas"),g("ralador-peneiras-abridor","Kit ralador + peneiras + abridor de latas"),g("jogo-americano","Jogo americano",2),g("temperos-mantimentos","Kit porta-temperos + potes para mantimentos"),g("triturador","Triturador elétrico"),g("garrafa-cafe","Garrafa de café"),g("mesa","Mesa",1,true,"Nenezinha") ]},
  ...
  { name: "Banheiro", icon: Bath, items: [g("toalhas","Jogo de toalhas",2),g("tapetes-sabonete","Kit tapetes + porta-sabonete líquido",2),g("cesto-roupas","Cesto de roupas"),g("lixeira-banheiro","Lixeira") ]},
  { name: "Quarto", icon: BedDouble, items: [g("lencois-luva","Jogo de lençóis + luva com elástico"),g("colcha-casal","Colcha de cama casal",2),g("cortina-quarto","Cortina",2)]},
